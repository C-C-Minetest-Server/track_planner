...
js:
	uglifyjs public/js/index.js --compress --mangle --source-map base=\'public/js/\' --output public/js/index.min.js
	echo -n "//# sourceMappingURL=index.min.js.map" >> public/js/index.min.js
